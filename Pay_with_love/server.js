...
mongoose.connect('mongodb+srv://user_name:password@test-db.dxurd.mongodb.net/?retryWrites=true&w=majority&appName=test-db')
  .then(() => {
...
// mongoose.connect('mongodb+srv://paytm_wallet:nextgen123@test-db.dxurd.mongodb.net/?retryWrites=true&w=majority&appName=test-db', {
